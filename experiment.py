...
wikipedia_cat_graph_class_egt.graph_to_file()

# wikipedia_cat_graph_class_gt.construct_graph(depth=3)
# wikipedia_cat_graph_class_gt.print_node_information()
# wikipedia_cat_graph_class_gt.print_edge_information()

# wikipedia_cat_graph_class_mh.construct_graph(depth=1)
# wikipedia_cat_graph_class_mh.print_node_information()
# wikipedia_cat_graph_class_mh.print_edge_information()

# wikipedia_cat_graph_class_ecohist.construct_graph(depth=3)
# wikipedia_cat_graph_class_ecohist.print_node_information()
# wikipedia_cat_graph_class_ecohist.print_edge_information()
